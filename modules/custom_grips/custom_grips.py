...
class CustomGrip(QWidget):
    ...
    def __init__(self, parent, position, disable_color = False):
        ...
        if position == Qt.TopEdge:
            self.wi.top(self)
            self.setGeometry(self.get_rect(Qt.TopEdge))
            ...
            # self.wi.top.mouseReleaseEvent = release_right
        ...
        # SHOW BOTTOM GRIP
            ...
            self.wi.bottom(self)
            self.setGeometry(self.get_rect(Qt.BottomEdge))
            self.setMaximumHeight(self.grip_width)
            ...
            # self.wi.bottom.mouseReleaseEvent = release_right
        ...
        # SHOW LEFT GRIP
            ...
            self.wi.left(self)
            self.setGeometry(self.get_rect(Qt.LeftEdge))
            self.setMaximumWidth(self.grip_width)
            ...
            # self.wi.leftgrip.mouseReleaseEvent = release_right
            # self.wi.top_left.mouseReleaseEvent = release_right
        ...
        # RESIZE RIGHT
            ...
            self.setGeometry(self.get_rect(Qt.RightEdge))
            self.setMaximumWidth(self.grip_width)
            ...
            # self.wi.rightgrip.mouseReleaseEvent = release_right

            # ENABLE COLOR
            if disable_color:
                self.wi.rightgrip.setStyleSheet("background-color: transparent")

    def get_rect(self, position):
        if position == Qt.TopEdge:
            rect = QRect(0, -2, self.parent.width(), 4)
        elif position == Qt.BottomEdge:
            rect = QRect(0, self.parent.height() - 4, self.parent.width(), 4)
        elif position == Qt.LeftEdge:
            rect = QRect(0, -5, 5, self.parent.height() + 20)
        elif position == Qt.RightEdge:
            rect = QRect(self.parent.width() - 4, 0, 10, self.parent.height() + 20)
        return rect

    def release_right(self):
        top_grip = self.parent.top_grip
        bottom_grip = self.parent.bottom_grip
        left_grip = self.parent.left_grip
        right_grip = self.parent.right_grip
        top_grip.setGeometry(self.get_rect(Qt.TopEdge))
        bottom_grip.setGeometry(self.get_rect(Qt.BottomEdge))
        left_grip.setGeometry(self.get_rect(Qt.LeftEdge))
        right_grip.setGeometry(self.get_rect(Qt.RightEdge))
